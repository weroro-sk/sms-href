...
export interface ISmsHref_PIAPI {
    /**
     ...
     */
    __fixAll(context?: TContext, shouldBypassNodeJs?: boolean): Promise<number>;
     ...
     */
    __fixValue<T extends TSmsHrefValue>(value: T): Promise<TSmsHrefValue | null>;
     ...
     */
    __create(phone: TPhone, message: TMessage): Promise<TSmsHrefValue | null>;
}
